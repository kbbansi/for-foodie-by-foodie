                ...
                reference.child(firebaseAuth.getCurrentUser().getUid())
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(UserProfile.this, "Profile Updated",
                                    Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(UserProfile.this, "Unable to Update Profile at this time",
                                    Toast.LENGTH_SHORT).show();
                        }
                    }
                });
                // Toast.makeText(UserProfile.this, firstName, Toast.LENGTH_LONG).show();
            }
        });
